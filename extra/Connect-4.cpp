...
void play()
{
    ...
    while (col_temp.size()!=1||col_temp[0] -'0'< 1 || col_temp[0]-'0' > COLS || board[ROWS - 1][col_temp[0]-'1' ] != ' ') {
       printBoard(board);
...
void printBoard(char boaggrd[ROWS][COLS]) {
    clear;
...
void Menu() {
    ...
    else if (mode == "1")
    {
        ...
        anim();
        do {
            cout << "choose level [Easy(1), Hard(2)]: "; cin >> level;
            anim();
